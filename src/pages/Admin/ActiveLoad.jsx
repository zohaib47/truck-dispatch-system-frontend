    ...
    <div className="min-h-screen bg-white p-4 md:p-10 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mb-10 md:mb-16 gap-8">
          {/* 1. Title - Mobile pe center, Desktop pe left */}
          ...
          {/* 2. CENTER TABS - Mobile pe full width aur grid, Desktop pe rounded pill */}
          <div className="w-full lg:w-auto overflow-hidden">
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:flex bg-[#F1F5F9] p-1.5 rounded-2xl lg:rounded-full border border-gray-100 shadow-inner gap-1">
              {[
                ...
                <button
                  ...
                  className={`flex items-center justify-center gap-2 px-4 lg:px-10 py-3 lg:py-3 rounded-xl lg:rounded-full text-[10px] lg:text-[10px] font-black uppercase italic transition-all ${
                    activeTab === tab.id
                      ? "bg-[#001529] text-white shadow-lg lg:scale-105"
                      : "text-gray-400 hover:text-[#001529] hover:bg-gray-200/50"
                  }`}
                >
          ...
          {/* 3. RIGHT STATS - Mobile pe center */}
          <div className="flex items-center justify-center gap-6 border-t lg:border-t-0 pt-4 lg:pt-0 border-gray-100 w-full lg:w-auto">
            ...
            <div className="flex flex-col items-center lg:items-end">
              ...
              <span className="text-lg md:text-xl font-black text-green-500">
                {stats.acceptCount}
              </span>
            </div>
          </div>
              ...
              filteredLoads.map((load) => (
                ...
                >
                  ...
                  <div className="absolute top-6 md:top-8 right-8 md:right-10 flex items-center gap-2">
                    ...
                    ></span>
                    <span className="text-[7px] md:text-[8px] font-black text-gray-300 uppercase tracking-tighter italic">
                      #{load._id.slice(-6)}
                    </span>
                  </div>
                  ...
                  <div className="space-y-5 md:space-y-6 relative mb-8 md:mb-10">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] md:text-xs font-bold text-[#001529] uppercase">
                          {load.pickupLocation}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="pt-6 md:pt-8 border-t border-gray-100 flex justify-between items-end">
                    <div className="max-w-[60%]">
                      <p className="text-[7px] font-black text-gray-400 uppercase mb-1">
                        Driver
                      </p>
                    ...
                    <div
                      className={`px-4 md:px-5 py-1.5 md:py-2 rounded-full text-[8px] md:text-[9px] font-black uppercase italic ${
                        load.status === "delivered" ||
                        load.status === "completed"
