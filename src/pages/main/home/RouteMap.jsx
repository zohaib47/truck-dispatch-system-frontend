      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-400 mt-3 text-sm max-w-xl">
            Our trucks are operating on live routes across Pakistan. Track the
            status of every delivery in real-time.{" "}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {routes.map((route) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span
                    className={`${route.statusColor} text-[9px] font-black text-white px-2.5 py-1 rounded-full uppercase tracking-wider`}
                  >
                    {route.status}
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 flex items-center gap-1">
                    ...
                    <span style={{ color: route.color }} className="text-xs">
                      🚛
                    </span>
                    <div className="h-px flex-1 border-t border-dashed border-gray-600"></div>
                  </div>
          ...
          {/* Map */}
          <div
            className="lg:col-span-2 rounded-3xl overflow-hidden border border-white/10 shadow-2xl"
            style={{ height: "440px" }}
          >
